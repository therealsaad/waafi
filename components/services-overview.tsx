...
const services = [
  {
    ...
    description:
      "Professional interior design consultancy supported by engineering and technical expertise.",
  ...
  },
  {
    ...
    description:
      "Reliable software solutions aligned with business requirements and scalable for growth.",
  ...
  },
  {
    ...
    description:
      "Secure digital commerce platforms with payment gateway and logistics integration.",
    slug: "e-commerce",
  },
  {
    icon: ShieldCheck,
    ...
    description:
      "Cyber security advisory services to strengthen your organization's digital resilience.",
    slug: "cyber-security",
  },
  {
    icon: Monitor,
    ...
    description:
      "Strategic advisory services supporting digital transformation and technology roadmaps.",
    slug: "it-consulting",
  },
]
