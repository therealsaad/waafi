...
<<<<<<< HEAD
            <div className="relative inline-block">
              <span
                className={cn(
                  "block text-lg font-semibold tracking-tight leading-tight transition-all duration-300",
                  scrolled ? "text-foreground" : "text-primary-foreground"
                )}
              >
                <span className="inline-block transition-opacity duration-200 group-hover:opacity-0">Waafi Associates</span>
              </span>

              <span className={cn(
                  "absolute left-0 top-0 w-full h-full flex items-center gap-2 whitespace-nowrap text-lg font-semibold pointer-events-none transition-all duration-300 opacity-0 translate-y-1",
                  scrolled ? "text-foreground" : "text-waafi-teal"
